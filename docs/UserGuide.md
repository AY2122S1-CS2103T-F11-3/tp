...
## Entering Commands
You can input commands into the Command Box to get HeRon to perform an operation.
...
`HOURS_WORKED`, `OVERTIME`| Whole numbers from 1 to 744.<br> (For `add`, `edit` commands,<br> 0 is allowed)| `12`, `1`
